...
object BFS {
  ...
  def buildBfsGraph(graph: Graph[(Int, String), Double]) = {
    graph.pregel(Int.MaxValue, 10, EdgeDirection.Out)(this.vprog, this.sendMsg, this.mergeMsg)
  }
  ...
  def sendMsg(triplet: EdgeTriplet[(Int, String), Double   ]): Iterator[(VertexId, Int)] = {
		...
		if((!isSrcMarked && isDstMarked) || (isSrcMarked && !isDstMarked)){
		   	if(isSrcMarked && ((triplet.dstAttr._2 == "DBPEDIA" && triplet.srcAttr._2 != "YAGO")|| (triplet.dstAttr._2 == "YAGO" && triplet.srcAttr._2 == "DBPEDIA") || (triplet.srcAttr._2 == "RESOURCE" && triplet.dstAttr._2 == "GND")))
				  Iterator((triplet.dstId,triplet.srcAttr._1+1))
	  		else if(isDstMarked && ((triplet.srcAttr._2 == "DBPEDIA" && triplet.dstAttr._2 != "YAGO") || (triplet.dstAttr._2 == "DBPEDIA" && triplet.srcAttr._2 == "YAGO") || (triplet.dstAttr._2 == "RESOURCE" && triplet.srcAttr._2 == "GND")))
